...
private fun sendDebugInfo(context: android.content.Context, driveInfo: DriveInfo?, toc: com.bitperfect.core.models.DiscToc?, rawToc: ByteArray?, offset: Int?, coverArtUrl: String?, ripStates: Map<Int, com.bitperfect.app.usb.TrackRipState>) {
    ...
    if (toc == null) {
        ...
        sb.appendLine("Lookup URL: `https://musicbrainz.org/ws/2/discid/$mbId?fmt=json&inc=artist-credits+recordings`")
        sb.appendLine("TOC Fallback URL: `https://musicbrainz.org/ws/2/discid/-?toc=$tocStr&fmt=json&inc=artist-credits+recordings&cdstubs=no`")
        sb.appendLine()
